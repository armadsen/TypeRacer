...
class StatsView: UIView {
    ...
    var averageWpm: Int? {
        didSet {
            ...
            var attrs = [NSAttributedString.Key.font: Appearance.titleFont(with: 60),
                         NSAttributedString.Key.foregroundColor: UIColor.white]
            let attributedString = NSMutableAttributedString(string: "\(averageWpm)", attributes: attrs)
            attrs[.font] = Appearance.titleFont(with: 16)
